module VideoHelper
  ...
  def campbell
    str = <<-HTML
    <embed src="http://blip.tv/play/g_MngZbMOwI" type="application/x-shockwave-flash" width="480" height="346" allowscriptaccess="always" allowfullscreen="true"></embed> 
    HTML
    str
  end
  def campbell
  ...
  def duncan
    str = <<-HTML
    <embed src="http://blip.tv/play/g_MngZLzVgI" type="application/x-shockwave-flash" width="480" height="346" allowscriptaccess="always" allowfullscreen="true"></embed> 
    HTML
  end
  ...
  def subelsky
    str = <<-HTML
    <embed src="http://blip.tv/play/g_MngZaxYQI" type="application/x-shockwave-flash" width="480" height="346" allowscriptaccess="always" allowfullscreen="true"></embed> 
    HTML
  end
  
  def stefanov
    str = <<-HTML
    <embed src="http://blip.tv/play/g_MngZSjPQI" type="application/x-shockwave-flash" width="480" height="346" allowscriptaccess="always" allowfullscreen="true"></embed> 
    HTML
  end
  ...
  def couch
    str = <<-HTML
    <embed src="http://blip.tv/play/g_MngZWNJAI" type="application/x-shockwave-flash" width="480" height="346" allowscriptaccess="always" allowfullscreen="true"></embed> 
    HTML
  end
  ...
  def resig
    str = <<-HTML
    <object width="480" height="264"><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=5284172&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00ADEF&amp;fullscreen=1" /><embed src="http://vimeo.com/moogaloop.swf?clip_id=5284172&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00ADEF&amp;fullscreen=1" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="480" height="264"></embed></object>
    <object width="480" height="264"><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="movie" value="http://vimeo.com/moogaloop.swf?clip_id=5289775&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00ADEF&amp;fullscreen=1" /><embed src="http://vimeo.com/moogaloop.swf?clip_id=5289775&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=1&amp;color=00ADEF&amp;fullscreen=1" type="application/x-shockwave-flash" allowfullscreen="true" allowscriptaccess="always" width="480" height="264"></embed></object>
    HTML
  end

  def moffitt
    str = <<-HTML
    <embed src="http://blip.tv/play/AYGPo0KY8ys" type="application/x-shockwave-flash" width="854" height="510" allowscriptaccess="always" allowfullscreen="true"></embed> 
    HTML
    str
  end
  def higgins
